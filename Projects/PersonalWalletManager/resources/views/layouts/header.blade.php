...
<html lang="en">
  <head>
    ...
    <title>Personal Wallet Manager</title>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
      <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#"> 
        @if(is_null(auth()->user()->photo))
          <img src="/uploads/user/logo.jpeg" height="25" class="img img-responsive" style="border-radius: 50%;">
        @else
          <img src="/uploads/user/{{ auth()->user()->photo }}" alt="" height="25" class="img img-responsive" style="border-radius: 50%;">
        @endif
